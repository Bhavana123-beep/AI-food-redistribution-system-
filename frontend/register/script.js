            ...
            if (isValid) {
                ...
                fetch('http://localhost:5000/register', {
                    ...
                    body: JSON.stringify({
                        ...
                        role: selectedRole,
                        licenseNumber: document.getElementById('license') ? document.getElementById('license').value.trim() : null,
                        ngoId: document.getElementById('ngoId') ? document.getElementById('ngoId').value.trim() : null
                    })
                })
                .then(async (res) => {
                    let data;
                    try {
                        ...
                        if (contentType && contentType.indexOf("application/json") !== -1) {
                            ...
                            data = { success: false, message: "Server returned a non-JSON response. Ensure backend is running and updated." };
                        }
                    } catch (e) {
